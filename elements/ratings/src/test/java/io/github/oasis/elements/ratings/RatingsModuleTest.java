 ...
 */
class RatingsModuleTest {

    private RatingsModule module;

    @BeforeEach
    void beforeEach() {
        module = new RatingsModule();
    }
    ...
    @Test
    void getParser() {
        Assertions.assertTrue(module.getParser() instanceof RatingParser);
    }
    ...
    void getSupportedSinks() {
        ...
        Assertions.assertTrue(supportedSinks.contains(RatingsSink.class));
    }
    ...
    void createSink() {
        ...
        AbstractSink firstSink = module.createSink(RatingsSink.class, contextSupport);
        AbstractSink secondSink = module.createSink(RatingsSink.class, contextSupport);
    ...
    void createProcessor() {
        ...
        RatingRule rule = Mockito.mock(RatingRule.class);
        ...
        Assertions.assertTrue(firstProcessor instanceof RatingProcessor);
        Assertions.assertTrue(secondProcessor instanceof RatingProcessor);
