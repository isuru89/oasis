 ...
 */
@DisplayName("Periodic Non-consecutive Streaks")
public class PeriodicNonConsecutiveStreakTest extends AbstractRuleTest {
    ...
    public void testNCHistogramStreakNHavingCNoEventTypes() {
        ...
        RuleContext<PeriodicStreakNRule> ruleContext = createRule(singleStreak, FIFTY, 80, signalsRef::add);
    ...
    public void testNCHistogramBreakStreakNOutOfOrder() {
        ...
        Set<Signal> signals = mergeSignals(signalsRef);
        printSignals(signals);
        PeriodicStreakNRule rule = ruleContext.getRule();
        assertStrict(signals,
    ...
    public void testNCHistogramMultiStreakN() {
        ...
        List<Signal> signalsRef = new ArrayList<>();
        RuleContext<PeriodicStreakNRule> ruleContext = createRule(multiStreaks, FIFTY, 80, signalsRef::add);
        PeriodicStreakNBadge streakN = new PeriodicStreakNBadge(pool, ruleContext);
        submitOrder(streakN, e1, e2, e3, e4, e5, e6, e7, e8);
    ...
    @DisplayName("Multiple streaks consecutively")
    @Test
    public void testNCHistogramMultiStreakNConsecutively() {
        TEvent e1 = TEvent.createKeyValue(100, EVT_A, 75);
        TEvent e2 = TEvent.createKeyValue(144, EVT_A, 63);
        TEvent e3 = TEvent.createKeyValue(205, EVT_A, 26);
        TEvent e4 = TEvent.createKeyValue(235, EVT_A, 96);
        ...
        TEvent e6 = TEvent.createKeyValue(311, EVT_A, 92);
        TEvent e7 = TEvent.createKeyValue(350, EVT_A, 84);
        TEvent e8 = TEvent.createKeyValue(419, EVT_A, 87);
        TEvent e9 = TEvent.createKeyValue(460, EVT_A, 91);
        TEvent e10 = TEvent.createKeyValue(531, EVT_A, 29);
