...
//                new Condition(1, "e.data.value > 100", 1),
//                new Condition(2, "e.data.value > 200", 2),
//                new Condition(3, "e.data.value > 300", 3)
//        ));
//
//        BadgeDef def2 = new BadgeDef();
...
//                new Condition(1, "e.data.value > 100", 1),
//                new Condition(2, "e.data.value > 200", 2),
//                new Condition(4, "e.data.value > 300", 3)
//        ));
//
//        Assertions.assertEquals(def1.generateUniqueHash(), def2.generateUniqueHash());
//        Assertions.assertNotEquals(def1.generateUniqueHash(), def3.generateUniqueHash());
...
//                new Threshold(BigDecimal.valueOf(100.0), 1),
//                new Threshold(BigDecimal.valueOf(200.0), 2),
//                new Threshold(BigDecimal.valueOf(300.0), 3)
//        ));
//
//        BadgeDef def2 = new BadgeDef();
...
//                new Threshold(BigDecimal.valueOf(100.0), 1),
//                new Threshold(BigDecimal.valueOf(200.0), 2),
//                new Threshold(BigDecimal.valueOf(500.0), 3)
//        ));
//
//        Assertions.assertEquals(def1.generateUniqueHash(), def2.generateUniqueHash());
//        Assertions.assertNotEquals(def1.generateUniqueHash(), def3.generateUniqueHash());
