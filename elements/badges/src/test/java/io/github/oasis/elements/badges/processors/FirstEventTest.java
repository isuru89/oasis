...
public class FirstEventTest extends AbstractRuleTest {
    ...
    public void testFirstWithoutConditionSameEvents() {
        ...
        assertSignal(signals, new BadgeSignal(rule.getId(), e1, e1.getTimestamp(), rule.getRankId(), 110, 110, e1.getExternalId(), e1.getExternalId()));
    }
    ...
    public void testFirstWithPoints() {
        ...
        assertSignal(signals,
                new BadgeSignal(rule.getId(), e1, e1.getTimestamp(), rule.getRankId(), 110, 110, e1.getExternalId(), e1.getExternalId())
    ...
    public void testFirstWithConditionSameEvents() {
        ...
        assertSignal(signals, new BadgeSignal(rule.getId(), e2, e2.getTimestamp(), rule.getRankId(), 144, 144, e2.getExternalId(), e2.getExternalId()));
    }
