...
import io.github.oasis.game.utils.TestMapState;
...
public class UtilsTest {
    ...
    public final ClearSystemProperties oasisGameIdCleared =
            new ClearSystemProperties(io.github.oasis.game.utils.Constants.ENV_OASIS_GAME_ID);
    ...
    public void testQueueReplace() {
        {
            ...
            System.setProperty(io.github.oasis.game.utils.Constants.ENV_OASIS_GAME_ID, "1");
            Assertions.assertEquals("queue.1.msg", Utils.queueReplace(qName));

            System.clearProperty(io.github.oasis.game.utils.Constants.ENV_OASIS_GAME_ID);
