...
public class TestConfiguration {
    ...
    private static final String SCHEMA_FILE_SQL = "schema-profile.sqlite.sql";
    ...
    public Jdbi createTestBean() throws IOException {
        System.out.println(">>> Creating jdbi");
    ...
    private String readSchemaResource() throws IOException {
        ...
        try (InputStream is = clsLoader.getResourceAsStream(SCHEMA_FILE_SQL)) {
